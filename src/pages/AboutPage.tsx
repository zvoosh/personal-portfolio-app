    ...
    <div className="w-100 h-100 flex justify-center flex-col mb-1">
      ...
      <div className="font-11">
        ...
        <p className="mt-2">
          ...
          problem-solving, algorithmic thinking, and scalable software design.
          My professional journey began with a part-time role at FactoryWW,
          where I worked with React to build two major projects from the ground
          up. This experience was pivotal—it allowed me to apply my academic
          knowledge in a real-world setting and sharpen my skills in frontend
          development. I also expanded my toolkit by working with technologies
          like Flask, Angular, and React, gaining hands-on experience in
          building dynamic and responsive web applications.
        </p>
        <p className="mt-1">
          Currently, I’m working as a Frontend Developer Intern at Unified
          Mentor, where I continue to grow as a developer, collaborate with
          experienced engineers, and contribute to meaningful projects. I’m
          passionate about creating intuitive user experiences, writing clean
          and maintainable code, and staying up-to-date with the latest trends
          in web development. Whether it's solving complex problems or learning
          a new framework, I thrive on challenges and am always eager to push my
          boundaries.
        </p>
      </div>
